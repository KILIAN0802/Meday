...
import { signInWithCredentials } from 'src/auth/context/jwt/action';

// ----------------------------------------------------------------------

export const SignInSchema = zod.object({
  username: zod.string().min(1, { message: 'Hãy nhập tên tài khoản!' }),
  password: zod.string().min(1, { message: 'Hãy nhập mật khẩu!' }).min(8, { message: '+8 kí tự!' }),
});
